...
public class PasswordResetService {
        ...
        /**
         * Gera um token de redefinição, armazena no banco e envia o e-mail com o link.
         *
        ...
        public void createPasswordResetToken(String cpf, String appUrl) throws Excecao {
                // Normaliza o CPF para garantir que a busca funcione mesmo com pontos/traços
        ...
        public void resetPassword(String token, String newPassword) throws Excecao {
                ...
                if (user.getResetTokenExpiryDate() != null
                        ...
                        // Limpa o token expirado no banco antes de lançar a exceção
                ...
                // 3. Invalida o token para segurança (não pode usar o mesmo link duas vezes)
                user.setResetToken(null);
                user.setResetTokenExpiryDate(null);
